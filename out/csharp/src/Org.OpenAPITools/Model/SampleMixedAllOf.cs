...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleMixedAllOf :  IEquatable<SampleMixedAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleMixedAllOf" /> class.
        /// </summary>
        /// <param name="ingredients">ingredients.</param>
        public SampleMixedAllOf(List<Sample> ingredients = default(List<Sample>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleMixedAllOf {\n");
        ...
        {
            return this.Equals(input as SampleMixedAllOf);
        }

        /// <summary>
        /// Returns true if SampleMixedAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleMixedAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleMixedAllOf input)
        {
            if (input == null)
                return false;
