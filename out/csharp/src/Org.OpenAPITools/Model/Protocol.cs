...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Protocol :  IEquatable<Protocol>, IValidatableObject
    {
        ...
        /// <param name="uniqueId">The SLIMS unique identifier for the protocol (required).</param>
        public Protocol(string name = default(string), string uniqueId = default(string))
        {
            // to ensure "uniqueId" is required (not null)
            if (uniqueId == null)
            {
                throw new InvalidDataException("uniqueId is a required property for Protocol and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The SLIMS unique identifier for the protocol
        /// </summary>
        /// <value>The SLIMS unique identifier for the protocol</value>
