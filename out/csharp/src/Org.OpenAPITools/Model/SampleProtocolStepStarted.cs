...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleProtocolStepStarted : BaseSampleEvent,  IEquatable<SampleProtocolStepStarted>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleProtocolStepStarted" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleProtocolStepStarted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleProtocolStepStarted" /> class.
        /// </summary>
        /// <param name="step">step.</param>
        public SampleProtocolStepStarted(string step = default(string), string eventType = "SampleProtocolStepStarted", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
            this.Step = step;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleProtocolStepStarted {\n");
        ...
        {
            return this.Equals(input as SampleProtocolStepStarted);
        }

        /// <summary>
        /// Returns true if SampleProtocolStepStarted instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleProtocolStepStarted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleProtocolStepStarted input)
        {
            if (input == null)
                return false;
