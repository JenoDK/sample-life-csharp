...
{
    /// <summary>
    /// SampleScheduledAllOf
    /// </summary>
    [DataContract]
    public partial class SampleScheduledAllOf :  IEquatable<SampleScheduledAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleScheduledAllOf" /> class.
        /// </summary>
        /// <param name="requested">requested.</param>
        /// <param name="workflow">workflow.</param>
        public SampleScheduledAllOf(string requested = default(string), string workflow = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleScheduledAllOf {\n");
        ...
        {
            return this.Equals(input as SampleScheduledAllOf);
        }

        /// <summary>
        /// Returns true if SampleScheduledAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleScheduledAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleScheduledAllOf input)
        {
            if (input == null)
                return false;
