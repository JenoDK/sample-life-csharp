...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Sample :  IEquatable<Sample>, IValidatableObject
    {
        ...
        public Sample(string barcode = default(string), string type = default(string), Dictionary<string, Object> detail = default(Dictionary<string, Object>))
        {
            // to ensure "barcode" is required (not null)
            if (barcode == null)
            {
                throw new InvalidDataException("barcode is a required property for Sample and cannot be null");
            }
            else
            {
