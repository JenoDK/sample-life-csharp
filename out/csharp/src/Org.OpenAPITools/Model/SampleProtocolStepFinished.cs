...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleProtocolStepFinished : BaseSampleEvent,  IEquatable<SampleProtocolStepFinished>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleProtocolStepFinished" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleProtocolStepFinished() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleProtocolStepFinished" /> class.
        /// </summary>
        /// <param name="step">step.</param>
        public SampleProtocolStepFinished(string step = default(string), string eventType = "SampleProtocolStepFinished", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
            this.Step = step;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleProtocolStepFinished {\n");
        ...
        {
            return this.Equals(input as SampleProtocolStepFinished);
        }

        /// <summary>
        /// Returns true if SampleProtocolStepFinished instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleProtocolStepFinished to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleProtocolStepFinished input)
        {
            if (input == null)
                return false;
