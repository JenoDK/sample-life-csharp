...
{
    /// <summary>
    /// SampleWorkflowFinishedAllOf
    /// </summary>
    [DataContract]
    public partial class SampleWorkflowFinishedAllOf :  IEquatable<SampleWorkflowFinishedAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleWorkflowFinishedAllOf" /> class.
        /// </summary>
        /// <param name="workflow">workflow.</param>
        public SampleWorkflowFinishedAllOf(string workflow = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleWorkflowFinishedAllOf {\n");
        ...
        {
            return this.Equals(input as SampleWorkflowFinishedAllOf);
        }

        /// <summary>
        /// Returns true if SampleWorkflowFinishedAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleWorkflowFinishedAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleWorkflowFinishedAllOf input)
        {
            if (input == null)
                return false;
