...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleProtocolFinished : BaseSampleEvent,  IEquatable<SampleProtocolFinished>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleProtocolFinished" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleProtocolFinished() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleProtocolFinished" /> class.
        /// </summary>
        public SampleProtocolFinished(string eventType = "SampleProtocolFinished", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleProtocolFinished {\n");
        ...
        {
            return this.Equals(input as SampleProtocolFinished);
        }

        /// <summary>
        /// Returns true if SampleProtocolFinished instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleProtocolFinished to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleProtocolFinished input)
        {
            if (input == null)
                return false;
