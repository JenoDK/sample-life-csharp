...
{
    /// <summary>
    /// SampleRescheduledAllOf
    /// </summary>
    [DataContract]
    public partial class SampleRescheduledAllOf :  IEquatable<SampleRescheduledAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleRescheduledAllOf" /> class.
        /// </summary>
        /// <param name="rescheduledTo">rescheduledTo.</param>
        public SampleRescheduledAllOf(string rescheduledTo = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleRescheduledAllOf {\n");
        ...
        {
            return this.Equals(input as SampleRescheduledAllOf);
        }

        /// <summary>
        /// Returns true if SampleRescheduledAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleRescheduledAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleRescheduledAllOf input)
        {
            if (input == null)
                return false;
