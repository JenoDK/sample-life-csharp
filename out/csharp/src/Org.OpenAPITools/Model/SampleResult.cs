...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleResult : BaseSampleEvent,  IEquatable<SampleResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleResult" /> class.
        /// </summary>
        ...
        public SampleResult(double value = default(double), string unit = default(string), string test = default(string), string eventType = "SampleResult", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
            this.Value = value;
            this.Unit = unit;
            this.Test = test;
        ...
        {
            return this.Equals(input as SampleResult);
        }

        /// <summary>
        /// Returns true if SampleResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleResult input)
        {
            if (input == null)
                return false;
