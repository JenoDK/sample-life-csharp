...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleWorkflowFinished : BaseSampleEvent,  IEquatable<SampleWorkflowFinished>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleWorkflowFinished" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleWorkflowFinished() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleWorkflowFinished" /> class.
        /// </summary>
        /// <param name="workflow">workflow.</param>
        public SampleWorkflowFinished(string workflow = default(string), string eventType = "SampleWorkflowFinished", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleWorkflowFinished {\n");
        ...
        {
            return this.Equals(input as SampleWorkflowFinished);
        }

        /// <summary>
        /// Returns true if SampleWorkflowFinished instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleWorkflowFinished to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleWorkflowFinished input)
        {
            if (input == null)
                return false;
