...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleFlaggedAllOf :  IEquatable<SampleFlaggedAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleFlaggedAllOf" /> class.
        /// </summary>
        /// <param name="flag">flag.</param>
        public SampleFlaggedAllOf(string flag = default(string))
        {
            this.Flag = flag;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleFlaggedAllOf {\n");
        ...
        {
            return this.Equals(input as SampleFlaggedAllOf);
        }

        /// <summary>
        /// Returns true if SampleFlaggedAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleFlaggedAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleFlaggedAllOf input)
        {
            if (input == null)
                return false;
