...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleCancelled : BaseSampleEvent,  IEquatable<SampleCancelled>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleCancelled" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleCancelled() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleCancelled" /> class.
        /// </summary>
        public SampleCancelled(string eventType = "SampleCancelled", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleCancelled {\n");
        ...
        {
            return this.Equals(input as SampleCancelled);
        }

        /// <summary>
        /// Returns true if SampleCancelled instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleCancelled to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleCancelled input)
        {
            if (input == null)
                return false;
