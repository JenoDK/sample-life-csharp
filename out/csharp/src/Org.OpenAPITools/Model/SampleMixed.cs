...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleMixed : BaseSampleEvent,  IEquatable<SampleMixed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleMixed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleMixed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleMixed" /> class.
        /// </summary>
        /// <param name="ingredients">ingredients.</param>
        public SampleMixed(List<Sample> ingredients = default(List<Sample>), string eventType = "SampleMixed", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
        ...
        public List<Sample> Ingredients { get; set; }
        ...
        {
            return this.Equals(input as SampleMixed);
        }

        /// <summary>
        /// Returns true if SampleMixed instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleMixed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleMixed input)
        {
            if (input == null)
                return false;
