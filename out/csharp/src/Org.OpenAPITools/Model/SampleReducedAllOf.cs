...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleReducedAllOf :  IEquatable<SampleReducedAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleReducedAllOf" /> class.
        /// </summary>
        /// <param name="subsamples">subsamples.</param>
        public SampleReducedAllOf(List<Sample> subsamples = default(List<Sample>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleReducedAllOf {\n");
        ...
        {
            return this.Equals(input as SampleReducedAllOf);
        }

        /// <summary>
        /// Returns true if SampleReducedAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleReducedAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleReducedAllOf input)
        {
            if (input == null)
                return false;
