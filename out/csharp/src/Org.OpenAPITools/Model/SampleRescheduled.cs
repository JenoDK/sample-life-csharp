...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleRescheduled : BaseSampleEvent,  IEquatable<SampleRescheduled>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleRescheduled" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleRescheduled() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleRescheduled" /> class.
        /// </summary>
        /// <param name="rescheduledTo">rescheduledTo.</param>
        public SampleRescheduled(string rescheduledTo = default(string), string eventType = "SampleRescheduled", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
            this.RescheduledTo = rescheduledTo;
        }

        /// <summary>
        /// Gets or Sets RescheduledTo
        /// </summary>
        [DataMember(Name="rescheduled_to", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleRescheduled {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  RescheduledTo: ").Append(RescheduledTo).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SampleRescheduled);
        }

        /// <summary>
        /// Returns true if SampleRescheduled instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleRescheduled to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleRescheduled input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.RescheduledTo == input.RescheduledTo ||
                    (this.RescheduledTo != null &&
                    this.RescheduledTo.Equals(input.RescheduledTo))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RescheduledTo != null)
                    hashCode = hashCode * 59 + this.RescheduledTo.GetHashCode();
                return hashCode;
            }
        }
