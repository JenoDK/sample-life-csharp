...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleFlagged : BaseSampleEvent,  IEquatable<SampleFlagged>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleFlagged" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleFlagged() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleFlagged" /> class.
        /// </summary>
        /// <param name="flag">flag.</param>
        public SampleFlagged(string flag = default(string), string eventType = "SampleFlagged", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
            this.Flag = flag;
        }
        ...
        {
            return this.Equals(input as SampleFlagged);
        }

        /// <summary>
        /// Returns true if SampleFlagged instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleFlagged to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleFlagged input)
        {
            if (input == null)
                return false;
