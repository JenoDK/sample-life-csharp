...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SampleReduced : BaseSampleEvent,  IEquatable<SampleReduced>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleReduced" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleReduced() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleReduced" /> class.
        /// </summary>
        /// <param name="subsamples">subsamples.</param>
        public SampleReduced(List<Sample> subsamples = default(List<Sample>), string eventType = "SampleReduced", Protocol protocol = default(Protocol)) : base(eventType, protocol)
        {
            this.Subsamples = subsamples;
        }

        /// <summary>
        /// Gets or Sets Subsamples
        /// </summary>
        [DataMember(Name="subsamples", EmitDefaultValue=false)]
        public List<Sample> Subsamples { get; set; }
        ...
        {
            return this.Equals(input as SampleReduced);
        }

        /// <summary>
        /// Returns true if SampleReduced instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleReduced to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleReduced input)
        {
            if (input == null)
                return false;
