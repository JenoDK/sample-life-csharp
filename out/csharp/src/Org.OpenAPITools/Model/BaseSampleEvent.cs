...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(SampleCancelled), "SampleCancelled")]
    [JsonSubtypes.KnownSubType(typeof(SampleFlagged), "SampleFlagged")]
    [JsonSubtypes.KnownSubType(typeof(SampleMixed), "SampleMixed")]
    [JsonSubtypes.KnownSubType(typeof(SampleProtocolFinished), "SampleProtocolFinished")]
    [JsonSubtypes.KnownSubType(typeof(SampleProtocolStepFinished), "SampleProtocolStepFinished")]
    [JsonSubtypes.KnownSubType(typeof(SampleProtocolStepStarted), "SampleProtocolStepStarted")]
    [JsonSubtypes.KnownSubType(typeof(SampleReduced), "SampleReduced")]
    [JsonSubtypes.KnownSubType(typeof(SampleRescheduled), "SampleRescheduled")]
    [JsonSubtypes.KnownSubType(typeof(SampleResult), "SampleResult")]
    [JsonSubtypes.KnownSubType(typeof(SampleScheduled), "SampleScheduled")]
    [JsonSubtypes.KnownSubType(typeof(SampleWorkflowFinished), "SampleWorkflowFinished")]
    public partial class BaseSampleEvent :  IEquatable<BaseSampleEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseSampleEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BaseSampleEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseSampleEvent" /> class.
        /// </summary>
        /// <param name="eventType">eventType (required).</param>
        /// <param name="protocol">protocol.</param>
        public BaseSampleEvent(string eventType = default(string), Protocol protocol = default(Protocol))
        {
            // to ensure "eventType" is required (not null)
            if (eventType == null)
            {
                throw new InvalidDataException("eventType is a required property for BaseSampleEvent and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseSampleEvent {\n");
        ...
        {
            return this.Equals(input as BaseSampleEvent);
        }

        /// <summary>
        /// Returns true if BaseSampleEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseSampleEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseSampleEvent input)
        {
            if (input == null)
                return false;
